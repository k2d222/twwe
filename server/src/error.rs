...
impl Display for Error {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Error::MaxUsers => write!(f, "maximum number of simultaneous connections reached"),
            ...
            Error::Token => write!(f, "access to this resource requires a valid session token"),
...
impl IntoResponse for Error {
    fn into_response(self) -> axum::response::Response {
        let status_code = match self {
            ...
            Error::MaxUsers => StatusCode::BAD_REQUEST,
            ...
            Error::Token => StatusCode::UNAUTHORIZED,
