...
<div class='edit-group'>  
  ...
  <label>Clip Width <input type="number" value={group.clipW} disabled={!group.clipping}
    on:change={(e) => onEditGroup({ group: g, clipW: intVal(e.target) })}></label>
  <label>Clip Height <input type="number" value={group.clipH} disabled={!group.clipping}
