...
const parser = LRParser.deserialize({
  ...
  nodeNames: "⚠ Comment file Config Header HeaderTok EndLine Runs Run NoLayerCopy NoLayerCopy IndexRules IndexRule Index Int Orient Flag XFLIP YFLIP ROTATE Pos Pos PosRule EMPTY FULL TileSpec INDEX NOTINDEX SpecList OR Random Random Float NoDefaultRule NoDefaultRule NewRun",
  maxTerm: 45,
  skippedNodes: [0,1],
  repeatNodeCount: 5,
