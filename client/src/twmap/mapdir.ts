...
export interface Group {
  ...
  parallax: Point<number>
  clipping: boolean
  clip: Point<FixedNum> & Extent<FixedNum>
}
...
export interface Quad {
  ...
  texture_coords: Uv<FixedNum>[] // length: 4
  position_env: string | null
  position_env_offset: number
  color_env: string | null
...
export interface PositionEnvelope extends EnvelopeCommon {
  ...
  points: EnvelopePoint<Point<FixedNum> & { rotation: FixedNum }>[]
}
